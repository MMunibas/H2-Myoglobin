...
$g16root/g16/g16 /data/toepfer/Project_Heme/H2_fit/H2_scan/h2.com /scratch/toepfer/h2/h2.out

# don't delete the result file if not able to copy to fileserver 
cp /scratch/toepfer/h2/h2.out /data/toepfer/Project_Heme/H2_fit/H2_scan/h2.out 
status=$?
if [ $status -eq 0 ] 
then 
...
to
	/data/toepfer/Project_Heme/H2_fit/H2_scan/h2.out
