...
{'cache_infile': False,
 'cache_me': {"('cc_test_flags', ['-O3'])": True,
              ...
              "('cc_test_flags', ['-mavx512fp16'])": False,
              ...
              "('feature_flags', 'AVX512_SKX')": ['-msse', '-msse2', '-msse3',
                                                  ...
                                                  '-mavx512vl', '-mavx512bw',
                                                  '-mavx512dq'],
              "('feature_flags', 'AVX512_SPR')": ['-msse', '-msse2', '-msse3',
                                                  '-mssse3', '-msse4.1',
                                                  '-mpopcnt', '-msse4.2',
                                                  '-mavx', '-mf16c', '-mfma',
                                                  '-mavx2', '-mavx512f',
              ...
              "('feature_flags', 'SSSE3')": ['-msse', '-msse2', '-msse3',
                                             '-mssse3'],
              "('feature_flags', {'SSE2', 'SSE', 'SSE3'})": ['-msse', '-msse2',
                                                             '-msse3'],
              ...
              "('feature_is_supported', 'AVX512_SPR', 'force_flags', 'macros', None, [])": False,
              ...
              "('feature_test', 'AVX512_SPR', None, 'macros', [])": False,
