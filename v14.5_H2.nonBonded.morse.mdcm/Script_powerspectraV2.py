...
path_psf = 'step3_pbcsetup.psf'

file_dcd_prefix = 'dyna'
file_dcd_suffix = ".dcd"
...
for h2_index in range(len(H2_res_list)):
    ...
    distfile = "h2distsV.H2-" + str(h2_index + 1) + ".dcd." + str(start_dcd) + "-" + str(end_dcd) + ".npy"
